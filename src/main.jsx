...
// Drop this file in your React app as `App.jsx`.
// TailwindCSS + Framer Motion required. Replace LOGO_SRC with your asset path.
const LOGO_SRC = "/assets/reconica-logo.svg"; // <- set your logo here
